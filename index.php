...
<head>
  ...
  <title>TAB FOOT COVER | Flagship Atelier</title>
  <meta name="description" content="Discover Tab Foot Cover at 181 Mercer Street, NYC. Dedicated to Ergonomic Heel-Tab Foot Covers & Low-Cut Athletic Hosiery and artisanal excellence.">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400..800;1,9..144,400..800&family=Outfit:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap">
  <link rel="stylesheet" href="assets/css/style.css">
</head>
<body>
<header class="site-header">
  <div class="container header-inner">
    <a href="index.php" class="brand-logo">TAB FOOT COVER</a>
...
<div class="mobile-drawer" id="mobile-drawer">
  <div class="drawer-header">
    <span class="brand-logo">TAB FOOT COVER</span>
  ...
  <section class="hero" style="border-bottom:1px solid var(--border-subtle); background:radial-gradient(ellipse at top left, #1b2a26 0%, #0e1412 75%); padding:5.5rem 0;">
    <div class="container" style="display:grid; grid-template-columns:1.1fr 0.9fr; gap:4rem; align-items:center;">
      <div>
        <div style="display:inline-flex; align-items:center; gap:0.6rem; background:rgba(20,31,28,0.7); border:1px solid var(--border-strong); padding:0.35rem 0.9rem; border-radius:999px; margin-bottom:1.5rem;">
          <span style="width:7px; height:7px; border-radius:50%; background:var(--accent-gold);"></span>
          <span style="font-family:var(--font-mono); font-size:0.78rem; color:var(--accent-gold); letter-spacing:0.08em; text-transform:uppercase;">Ergonomic Hosiery &bull; Heel-Tab Architecture</span>
        </div>
        <h1 style="font-size:3.4rem; line-height:1.15; letter-spacing:-0.01em; margin-bottom:1.5rem;">Anatomical Heel-Tab Cushioning & Low-Cut Foot Covers</h1>
        <p style="font-size:1.15rem; color:var(--text-secondary); line-height:1.8; margin-bottom:2.25rem;">Knitted on 200-needle circular looms from organic combed bamboo and long-staple merino wool at 181 Mercer Street. Featuring raised Achilles anti-blister tabs, seamless hand-linked toe closures, and anatomical arch compression for barefoot athletic precision.</p>
        <div style="display:flex; gap:1.25rem; align-items:center; flex-wrap:wrap;">
          <a href="services.html" class="btn-primary">Explore Tab Foot Covers</a>
          <a href="about.html" class="btn-secondary">Knitwear Heritage</a>
        </div>
      </div>
      <div style="position:relative;">
        <div style="border-radius:20px; overflow:hidden; border:1px solid var(--border-strong); box-shadow:0 25px 60px rgba(0,0,0,0.65);">
          <img src="assets/images/tabfootcover_asset_22.jpg" alt="sock st478ab costume accessory" style="width:100%; height:500px; object-fit:cover;">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-pad">
    <div class="container">
      ...
      <div class="grid-3">
        <div class="card">
          <img src="assets/images/tabfootcover_asset_23.jpg" alt="sock st530ab costume accessory">
          <div class="card-body">
        ...
        <div class="card">
          <img src="assets/images/tabfootcover_asset_24.jpg" alt="sockor nordiska museet nm.00111">
          <div class="card-body">
        ...
        <div class="card">
          <img src="assets/images/tabfootcover_asset_25.jpg" alt="socks pair of am 13364 2">
          <div class="card-body">
  ...
  <section class="section-pad">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Tailored commissions engineered for connoisseurs of Ergonomic Heel-Tab Foot Covers & Low-Cut Athletic Hosiery.</p>
      </div>
      <div class="grid-2">
        <div class="card" style="display:grid; grid-template-columns:1fr 1fr; align-items:center;">
          <img src="assets/images/tabfootcover_asset_26.jpg" alt="socks pair of am 589926 4" style="height:100%; object-fit:cover;">
          <div class="card-body">
        ...
        <div class="card" style="display:grid; grid-template-columns:1fr 1fr; align-items:center;">
          <img src="assets/images/tabfootcover_asset_28.jpg" alt="socks 2024" style="height:100%; object-fit:cover;">
          <div class="card-body">
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container" style="display:grid; grid-template-columns:1fr 1.1fr; gap:4rem; align-items:center;">
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.5rem;">
        <img src="assets/images/tabfootcover_asset_29.jpg" alt="socks for sale in tokyo" style="border-radius:var(--radius-md); height:280px; width:100%; object-fit:cover;">
        <img src="assets/images/tabfootcover_asset_30.jpg" alt="socks with a hole" style="border-radius:var(--radius-md); height:280px; width:100%; object-fit:cover; margin-top:2rem;">
      </div>
      <div>
        <span class="eyebrow">The Atelier Chronicle</span>
        <h2>A Tradition of Patient Hands in the Heart of SoHo</h2>
        <p style="color:var(--text-secondary); line-height:1.8; margin-bottom:1.5rem;">Since our founding at 181 Mercer Street, Tab Foot Cover has stood as a bastion of tactile discipline. While commercial entities pursue automated shortcuts, our workshop remains committed to the slow, meditative cadence of traditional hand finishing.</p>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Our Flagship Atelier (TAB FOOT COVER)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Unsolicited feedback from patrons who demand uncompromised excellence in Ergonomic Heel-Tab Foot Covers & Low-Cut Athletic Hosiery.</p>
      </div>
      <div class="grid-3">
        <div class="quote-card">
          <p class="quote-text">"The bespoke execution delivered by Tab Foot Cover is extraordinary. The tactile feel and flawless balance prove their unwavering adherence to classical hand methods."</p>
...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-bottom">
      <span>&copy; 2026 TAB FOOT COVER. All rights reserved. Certified Handcrafted Static Architecture.</span>
